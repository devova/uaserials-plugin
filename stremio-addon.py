...
STREAMS = {
    ...
    "series": {
        ...
        "hpytt0147753:1:1": [{"title": "YouTube", "ytId": "5EQw5NYlbyE"}],
        "hpytt0147753:1:2": [{"title": "YouTube", "ytId": "ZzdBKcVzx9Y"}],
    },
}
...
def addon_meta(type, id):
    ...
    meta = {
        "meta": next(
            (mk_item(item) for item in CATALOG[type] if item["id"] == id), None
        )
    }
